...
export const products: Product[] = [
  {
    ...
    price: 24.99,
    category: 'book',
    age_groups: ['preschool', 'elementary'],
  ...
  },
  {
    ...
    price: 14.99,
    category: 'poster',
    age_groups: ['preschool', 'elementary', 'middle'],
    images: ['/placeholder.svg'],
    featured: true,
  ...
  },
  {
    ...
    price: 16.99,
    category: 'poster',
    age_groups: ['elementary', 'middle', 'teen'],
    images: ['/placeholder.svg'],
  ...
  },
  {
    ...
    price: 39.99,
    category: 'custom',
    age_groups: ['toddler', 'preschool', 'elementary', 'middle'],
    images: ['/placeholder.svg'],
    featured: true,
